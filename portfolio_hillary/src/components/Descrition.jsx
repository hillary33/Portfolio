export function Descrition() {
    return(
        <>
            <div className="ctn-Descrition">
                ...
                <p>
                Em dezembro de 2023, iniciei um estágio na startup MStore Digital, onde tive contato com TypeScript, Insomnia, Prisma, Next.js e outras bibliotecas. Essa experiência me permitiu observar e aprender com profissionais experientes, aprimorando ainda mais minhas competências técnicas.
                </p>
                <p>
                Além disso, na faculdade, participei de workshops e eventos, onde pude explorar diferentes vertentes da TI e aprender com professores brilhantes. Essas experiências me ajudaram a construir uma base sólida de conhecimento e a desenvolver uma paixão pela área de front-end.
                </p>
            </div>
        </>
    )
